...
public class PostJob_withoutSelect_SalaryType extends TC_LoginPage {
    @Test(priority = 6)

    public void without_Select_SalaryType() throws InterruptedException
    {
        PostJob_Model salary = new PostJob_Model(driver);
        salary.SalaryTypeBlank("Senior Software Engineer","Mobile desktop application Quality Assure","70000","Dhaka","03","04-05-02024");
