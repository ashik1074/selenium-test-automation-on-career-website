...
public class keep_VacancyLocation_blank extends TC_LoginPage {
    @Test(priority = 8)

    public void CountryBlank() throws InterruptedException
    {
        PostJob_Model countryBlank = new PostJob_Model(driver);
        countryBlank.countryBlank("Senior Software Engineer","Mobile desktop application Quality Assure","70000","Dhaka","03","04-05-02024");
