...
public class Keep_VacancyType_blank extends TC_LoginPage {

@Test(priority = 7)
    public void keep_Title_Blank() throws InterruptedException
{
    PostJob_Model vacancyType = new PostJob_Model(driver);
    vacancyType.vacancyBlank("Senior Software Engineer","Mobile desktop application Quality Assure","70000","Dhaka","03","04-05-02024");
