...
public class keep_TimeZone_blank extends TC_LoginPage {

    @Test(priority = 9)

    public void keepTimeZone_Blank() throws InterruptedException
    {
        PostJob_Model TimeZone = new PostJob_Model(driver);
        TimeZone.Timezone("Senior Software Engineer","Mobile desktop application Quality Assure","70000","Dhaka","03","04-05-02024");
